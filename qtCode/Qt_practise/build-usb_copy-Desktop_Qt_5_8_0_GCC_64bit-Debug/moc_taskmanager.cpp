...
#include "../usb_copy/taskmanager.h"
...
QT_MOC_LITERAL(1, 12, 12), // "taskFinished"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 6), // "taskid"
QT_MOC_LITERAL(4, 33, 7) // "success"

    },
    "TaskManager\0taskFinished\0\0taskid\0"
    "success"
};
...
void TaskManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->taskFinished((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (TaskManager::*_t)(int , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TaskManager::taskFinished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject TaskManager::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_TaskManager.data,
...
// SIGNAL 0
void TaskManager::taskFinished(int _t1, bool _t2)
{
