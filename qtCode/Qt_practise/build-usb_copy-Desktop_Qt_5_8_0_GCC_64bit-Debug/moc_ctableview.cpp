...
QT_MOC_LITERAL(1, 11, 15), // "hoverRowChanged"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 3), // "row"
QT_MOC_LITERAL(4, 32, 9), // "updateRow"
QT_MOC_LITERAL(5, 42, 5) // "index"

    },
    "CTableView\0hoverRowChanged\0\0row\0"
    "updateRow\0index"
};
...
void CTableView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CTableView *_t = static_cast<CTableView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->hoverRowChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->updateRow((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CTableView::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CTableView::hoverRowChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject CTableView::staticMetaObject = {
    { &QTableView::staticMetaObject, qt_meta_stringdata_CTableView.data,
      qt_meta_data_CTableView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void CTableView::hoverRowChanged(int _t1)
{
